...
export function Login() {
  ...
  const testId = "169589393731-fcq6osljk6rq7hta5t5mcumtkf963r60.apps.googleusercontent.com";
                  ...
                  <div className="container">
                    <div className="banner">
                      <div className="login-format">
                        <img className="entrego-logo" src="https://rec-data.kalibrr.com/logos/LDC3AY6PVYPWEJD4SMTGGC63GX96WNTQMGSHWJBX-5bad80fb.png"></img>
                        <h1 style={{fontSize: 35, transform: "rotate(-25deg)", position: 'fixed', float: "inline-start", marginTop: '65px'}}>Shop</h1>
                        <div className="email-disclaimer">
                          <span>Please login using your </span><strong>registered work e-mail</strong>
                          <span>
